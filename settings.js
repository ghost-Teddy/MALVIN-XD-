...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~pnkTTRzL#0YA8HepdncpT0AA8pjqxgQRAYMSplZa4OmXRyZ6OZZ4",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "Ghost",
...
// add alive msg here 
        ...
        STICKER_NAME: process.env.STICKER_NAME || "Ghost",
...
OWNER_NAME: process.env.OWNER_NAME || "GhostTeddy",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*© Me*",
// add bot owner name    
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "27729553200",
